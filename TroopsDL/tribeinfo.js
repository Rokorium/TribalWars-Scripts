...
//Fixed by added check for location of screen and removing deprecated global variable "mode" reference. - Rokoria 9-13-2025
function openUI() {
...
function readData() {
    // Check if we are in the alliance page with mode set to members
    if (window.location.pathname != "/game.php" || game_data.screen != "ally" || game_data.mode != "members") {
        UI.ErrorMessage("You must be in the Tribe Menu in the Members tab and Summary Tab", 5000);
        return;
    }
